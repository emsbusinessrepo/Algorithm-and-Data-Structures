...
class trie_alphabet_nodes:
    ...
    def __init__(self):
        ...
        self.occurence_count = 0               # Counts for the number of strings with this as a prefix
...
class Trie:
    ...
    def getLongestChain(self, query_str):
        """
        ...
        return origin.occurence_count

text = ["abc", "dbcef", "gdbc", "abcd"]
student_trie = Trie(text)
string_frequency = student_trie.getLongestChain("bc")
print(string_frequency)
string_frequency = student_trie.getLongestChain("abc")
print(string_frequency)